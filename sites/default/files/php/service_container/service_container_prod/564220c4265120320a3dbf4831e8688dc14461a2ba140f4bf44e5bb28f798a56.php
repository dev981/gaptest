...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'config_translation.access.form' => 'getConfigTranslation_Access_FormService',
            'config_translation.access.overview' => 'getConfigTranslation_Access_OverviewService',
            'config_translation.route_subscriber' => 'getConfigTranslation_RouteSubscriberService',
            'contact.mail_handler' => 'getContact_MailHandlerService',
            'container.namespaces' => 'getContainer_NamespacesService',
            'content_translation.manage_access' => 'getContentTranslation_ManageAccessService',
            'content_translation.manager' => 'getContentTranslation_ManagerService',
            'content_translation.overview_access' => 'getContentTranslation_OverviewAccessService',
            'content_translation.subscriber' => 'getContentTranslation_SubscriberService',
            'content_translation.synchronizer' => 'getContentTranslation_SynchronizerService',
            'content_translation.updates_manager' => 'getContentTranslation_UpdatesManagerService',
            ...
            'path_processor_language' => 'getPathProcessorLanguageService',
            'path_processor_manager' => 'getPathProcessorManagerService',
            'path_subscriber' => 'getPathSubscriberService',
            'pathauto.alias_cleaner' => 'getPathauto_AliasCleanerService',
            'pathauto.alias_storage_helper' => 'getPathauto_AliasStorageHelperService',
            'pathauto.alias_uniquifier' => 'getPathauto_AliasUniquifierService',
            'pathauto.manager' => 'getPathauto_ManagerService',
            'pathauto.verbose_messenger' => 'getPathauto_VerboseMessengerService',
            'plugin.cache_clearer' => 'getPlugin_CacheClearerService',
            'plugin.manager.action' => 'getPlugin_Manager_ActionService',
            'plugin.manager.alias_type' => 'getPlugin_Manager_AliasTypeService',
            ...
            'plugin.manager.config_translation.mapper' => 'getPlugin_Manager_ConfigTranslation_MapperService',
    ...
    /**
     * Gets the 'config_translation.access.form' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\config_translation\Access\ConfigTranslationFormAccess A Drupal\config_translation\Access\ConfigTranslationFormAccess instance.
     */
    protected function getConfigTranslation_Access_FormService()
    {
        $this->services['config_translation.access.form'] = $instance = new \Drupal\config_translation\Access\ConfigTranslationFormAccess($this->get('plugin.manager.config_translation.mapper'), $this->get('language_manager'));

        $instance->_serviceId = 'config_translation.access.form';

        return $instance;
    }

    /**
     * Gets the 'config_translation.access.overview' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\config_translation\Access\ConfigTranslationOverviewAccess A Drupal\config_translation\Access\ConfigTranslationOverviewAccess instance.
     */
    protected function getConfigTranslation_Access_OverviewService()
    {
        $this->services['config_translation.access.overview'] = $instance = new \Drupal\config_translation\Access\ConfigTranslationOverviewAccess($this->get('plugin.manager.config_translation.mapper'), $this->get('language_manager'));

        $instance->_serviceId = 'config_translation.access.overview';

        return $instance;
    }

    /**
     * Gets the 'config_translation.route_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\config_translation\Routing\RouteSubscriber A Drupal\config_translation\Routing\RouteSubscriber instance.
     */
    protected function getConfigTranslation_RouteSubscriberService()
    {
        $this->services['config_translation.route_subscriber'] = $instance = new \Drupal\config_translation\Routing\RouteSubscriber($this->get('plugin.manager.config_translation.mapper'));

        $instance->_serviceId = 'config_translation.route_subscriber';
    ...
    /**
     * Gets the 'content_translation.manage_access' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\content_translation\Access\ContentTranslationManageAccessCheck A Drupal\content_translation\Access\ContentTranslationManageAccessCheck instance.
     */
    protected function getContentTranslation_ManageAccessService()
    {
        $this->services['content_translation.manage_access'] = $instance = new \Drupal\content_translation\Access\ContentTranslationManageAccessCheck($this->get('entity.manager'), $this->get('language_manager'));

        $instance->_serviceId = 'content_translation.manage_access';

        return $instance;
    }

    /**
     * Gets the 'content_translation.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\content_translation\ContentTranslationManager A Drupal\content_translation\ContentTranslationManager instance.
     */
    protected function getContentTranslation_ManagerService()
    {
        $this->services['content_translation.manager'] = $instance = new \Drupal\content_translation\ContentTranslationManager($this->get('entity.manager'), $this->get('content_translation.updates_manager'));

        $instance->_serviceId = 'content_translation.manager';

        return $instance;
    }

    /**
     * Gets the 'content_translation.overview_access' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\content_translation\Access\ContentTranslationOverviewAccess A Drupal\content_translation\Access\ContentTranslationOverviewAccess instance.
     */
    protected function getContentTranslation_OverviewAccessService()
    {
        $this->services['content_translation.overview_access'] = $instance = new \Drupal\content_translation\Access\ContentTranslationOverviewAccess($this->get('entity.manager'));

        $instance->_serviceId = 'content_translation.overview_access';

        return $instance;
    }

    /**
     * Gets the 'content_translation.subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\content_translation\Routing\ContentTranslationRouteSubscriber A Drupal\content_translation\Routing\ContentTranslationRouteSubscriber instance.
     */
    protected function getContentTranslation_SubscriberService()
    {
        $this->services['content_translation.subscriber'] = $instance = new \Drupal\content_translation\Routing\ContentTranslationRouteSubscriber($this->get('content_translation.manager'));

        $instance->_serviceId = 'content_translation.subscriber';

        return $instance;
    }

    /**
     * Gets the 'content_translation.synchronizer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\content_translation\FieldTranslationSynchronizer A Drupal\content_translation\FieldTranslationSynchronizer instance.
     */
    protected function getContentTranslation_SynchronizerService()
    {
        $this->services['content_translation.synchronizer'] = $instance = new \Drupal\content_translation\FieldTranslationSynchronizer($this->get('entity.manager'));

        $instance->_serviceId = 'content_translation.synchronizer';

        return $instance;
    }

    /**
     * Gets the 'content_translation.updates_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\content_translation\ContentTranslationUpdatesManager A Drupal\content_translation\ContentTranslationUpdatesManager instance.
     */
    protected function getContentTranslation_UpdatesManagerService()
    {
        $this->services['content_translation.updates_manager'] = $instance = new \Drupal\content_translation\ContentTranslationUpdatesManager($this->get('entity.manager'), $this->get('entity.definition_update_manager'));

        $instance->_serviceId = 'content_translation.updates_manager';
    ...
    {
        $this->services['language.config_subscriber'] = $instance = new \Drupal\language\EventSubscriber\ConfigSubscriber($this->get('language_manager'), $this->get('language.default'));
    ...
    {
        $this->services['language.default'] = $instance = new \Drupal\Core\Language\LanguageDefault(array('uuid' => 'ba41ed66-da0e-4ea8-8316-2200a59ca5a9', 'langcode' => 'en', 'status' => true, 'dependencies' => array(), 'id' => 'en', 'label' => 'English', 'direction' => 'ltr', 'weight' => 0, 'locked' => false));
     ...
     */
    public function getLanguageConverterService($lazyLoad = true)
    {
        if ($lazyLoad) {
            return $this->services['language_converter'] = new Drupal_language_LanguageConverter_Proxy($this, 'language_converter');
        }
        $instance = new \Drupal\language\LanguageConverter($this->get('language_manager'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\language\EventSubscriber\LanguageRequestSubscriber A Drupal\language\EventSubscriber\LanguageRequestSubscriber instance.
     */
    protected function getLanguageRequestSubscriberService()
    {
        $this->services['language_request_subscriber'] = $instance = new \Drupal\language\EventSubscriber\LanguageRequestSubscriber($this->get('language_manager'), $this->get('language_negotiator'), $this->get('string_translation'), $this->get('current_user'));

        $instance->_serviceId = 'language_request_subscriber';
    ...
    /**
     * Gets the 'path_processor_language' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\language\HttpKernel\PathProcessorLanguage A Drupal\language\HttpKernel\PathProcessorLanguage instance.
     */
    protected function getPathProcessorLanguageService()
    {
        $this->services['path_processor_language'] = $instance = new \Drupal\language\HttpKernel\PathProcessorLanguage($this->get('config.factory'), $this->get('language_manager'), $this->get('language_negotiator'), $this->get('current_user'));

        $instance->_serviceId = 'path_processor_language';
    ...
    {
        $a = $this->get('path_processor_language');
        $b = $this->get('path_processor_front');
        $c = $this->get('path_processor_alias');
        ...
        $instance->addInbound($a, 300);
        $instance->addInbound($this->get('path_processor.files'), 200);
        $instance->addInbound($b, 200);
        $instance->addInbound($c, 100);
        $instance->addOutbound($c, 300);
        $instance->addOutbound($b, 200);
        $instance->addOutbound($a, 100);
    ...
    /**
     * Gets the 'pathauto.alias_cleaner' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\pathauto\AliasCleaner A Drupal\pathauto\AliasCleaner instance.
     */
    protected function getPathauto_AliasCleanerService()
    {
        $this->services['pathauto.alias_cleaner'] = $instance = new \Drupal\pathauto\AliasCleaner($this->get('config.factory'), $this->get('pathauto.alias_storage_helper'));

        $instance->_serviceId = 'pathauto.alias_cleaner';

        return $instance;
    }

    /**
     * Gets the 'pathauto.alias_storage_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\pathauto\AliasStorageHelper A Drupal\pathauto\AliasStorageHelper instance.
     */
    protected function getPathauto_AliasStorageHelperService()
    {
        $this->services['pathauto.alias_storage_helper'] = $instance = new \Drupal\pathauto\AliasStorageHelper($this->get('config.factory'), $this->get('path.alias_storage'), $this->get('database'), $this->get('pathauto.verbose_messenger'), $this->get('string_translation'));

        $instance->_serviceId = 'pathauto.alias_storage_helper';

        return $instance;
    }

    /**
     * Gets the 'pathauto.alias_uniquifier' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\pathauto\AliasUniquifier A Drupal\pathauto\AliasUniquifier instance.
     */
    protected function getPathauto_AliasUniquifierService()
    {
        $this->services['pathauto.alias_uniquifier'] = $instance = new \Drupal\pathauto\AliasUniquifier($this->get('config.factory'), $this->get('pathauto.alias_storage_helper'), $this->get('module_handler'), $this->get('router.no_access_checks'));

        $instance->_serviceId = 'pathauto.alias_uniquifier';

        return $instance;
    }

    /**
     * Gets the 'pathauto.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\pathauto\PathautoManager A Drupal\pathauto\PathautoManager instance.
     */
    protected function getPathauto_ManagerService()
    {
        $this->services['pathauto.manager'] = $instance = new \Drupal\pathauto\PathautoManager($this->get('config.factory'), $this->get('language_manager'), $this->get('cache.default'), $this->get('module_handler'), $this->get('token'), $this->get('pathauto.alias_cleaner'), $this->get('pathauto.alias_storage_helper'), $this->get('pathauto.alias_uniquifier'), $this->get('pathauto.verbose_messenger'), $this->get('string_translation'));

        $instance->_serviceId = 'pathauto.manager';

        return $instance;
    }

    /**
     * Gets the 'pathauto.verbose_messenger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\pathauto\VerboseMessenger A Drupal\pathauto\VerboseMessenger instance.
     */
    protected function getPathauto_VerboseMessengerService()
    {
        $this->services['pathauto.verbose_messenger'] = $instance = new \Drupal\pathauto\VerboseMessenger($this->get('config.factory'), $this->get('current_user'));

        $instance->_serviceId = 'pathauto.verbose_messenger';
    ...
    public function getPlugin_CacheClearerService($lazyLoad = true)
    {
        ...
        $instance->addCachedDiscovery($this->get('plugin.manager.config_translation.mapper'));
        ...
        $instance->addCachedDiscovery($this->get('plugin.manager.alias_type'));
    ...
    /**
     * Gets the 'plugin.manager.alias_type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\pathauto\AliasTypeManager A Drupal\pathauto\AliasTypeManager instance.
     */
    protected function getPlugin_Manager_AliasTypeService()
    {
        $this->services['plugin.manager.alias_type'] = $instance = new \Drupal\pathauto\AliasTypeManager($this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));

        $instance->_serviceId = 'plugin.manager.alias_type';
    ...
    /**
     * Gets the 'plugin.manager.config_translation.mapper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\config_translation\ConfigMapperManager A Drupal\config_translation\ConfigMapperManager instance.
     */
    protected function getPlugin_Manager_ConfigTranslation_MapperService()
    {
        $this->services['plugin.manager.config_translation.mapper'] = $instance = new \Drupal\config_translation\ConfigMapperManager($this->get('cache.default'), $this->get('language_manager'), $this->get('module_handler'), $this->get('config.typed'), $this->get('theme_handler'));

        $instance->_serviceId = 'plugin.manager.config_translation.mapper';
    ...
    protected function getAccessManager_CheckProviderService()
    {
        ...
        $instance->addCheckService('config_translation.access.overview', 'access', array(0 => '_config_translation_overview_access'), false);
        $instance->addCheckService('config_translation.access.form', 'access', array(0 => '_config_translation_form_access'), false);
        ...
        $instance->addCheckService('content_translation.overview_access', 'access', array(0 => '_access_content_translation_overview'), false);
        $instance->addCheckService('content_translation.manage_access', 'access', array(0 => '_access_content_translation_manage'), false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'config_translation' => array(
                    'type' => 'module',
                    'pathname' => 'core/modules/config_translation/config_translation.info.yml',
                    'filename' => 'config_translation.module',
                ),
                'contact' => array(
                    'type' => 'module',
                ...
                'custom_api' => array(
                    'type' => 'module',
                    'pathname' => 'modules/custom/custom_api/custom_api.info.yml',
                    'filename' => 'custom_api.module',
                ),
                'datetime' => array(
                    'type' => 'module',
                ...
                'lang_dropdown' => array(
                    'type' => 'module',
                    'pathname' => 'modules/custom/lang_dropdown/lang_dropdown.info.yml',
                    'filename' => 'lang_dropdown.module',
                ),
                'language' => array(
                    'type' => 'module',
                ...
                'token' => array(
                    'type' => 'module',
                    'pathname' => 'modules/custom/token/token.info.yml',
                ...
                'pathauto' => array(
                    'type' => 'module',
                    'pathname' => 'modules/custom/pathauto/pathauto.info.yml',
                    'filename' => 'pathauto.module',
                ),
                'content_translation' => array(
                    'type' => 'module',
                    'pathname' => 'core/modules/content_translation/content_translation.info.yml',
                    'filename' => 'content_translation.module',
                ),
                'views' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\custom_api' => 'modules/custom/custom_api/src',
                ...
                'Drupal\\lang_dropdown' => 'modules/custom/lang_dropdown/src',
                ...
                'Drupal\\token' => 'modules/custom/token/src',
                ...
                'Drupal\\pathauto' => 'modules/custom/pathauto/src',
            ...
            'language.default_values' => array(
                'uuid' => 'ba41ed66-da0e-4ea8-8316-2200a59ca5a9',
                'langcode' => 'en',
                'status' => true,
                'dependencies' => array(
 ...
 * @see \Drupal\Component\ProxyBuilder
 */
class Drupal_language_LanguageConverter_Proxy implements \Drupal\Core\ParamConverter\ParamConverterInterface
{
