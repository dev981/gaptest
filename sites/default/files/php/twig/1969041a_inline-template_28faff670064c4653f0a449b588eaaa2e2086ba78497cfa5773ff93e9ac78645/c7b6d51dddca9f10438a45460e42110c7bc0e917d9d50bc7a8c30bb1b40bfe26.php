...
/* {# inline_template_start #}<a href="{{ path }} " target= "_blank">{{ field_thumbnail }}</a> */
class __TwigTemplate_03920b77064eb9a3bfa28786723d638db454c67c72dfa66c1f5b175a0e116691 extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}<a href=\"{{ path }} \" target= \"_blank\">{{ field_thumbnail }}</a>";
    }
